...
The State pattern was used the most as it fit the game loop perfectly - an abstract 'State' that had its data and behavior subdivided into handling input, processing updates, and displaying the output. This pattern solved the problem of data encapsulation, and separation of concerns while providing a common interface fo the game loop.
